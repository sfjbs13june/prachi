...
import com.prachi.app.model.Employee;
import com.prachi.app.model.EmployeeRepository;
...
public class StreamTest {
    ...
    public void whenFindFirst_thenGetFirstEmployeeInStream() {
        ...
        Assertions.assertEquals(employee.getSalary(), new Double(200000));
    ...
    public void whenFindMax_thenGetMaxElementFromStream() {
        ...
        Assertions.assertEquals(maxSalEmp.getSalary(), new Double(300000.0));
    }
